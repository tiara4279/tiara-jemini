...
for idx, info in enumerate(RISK_INDICATORS):
    ...
    <style>
      * {{ margin:0; padding:0; box-sizing:border-box; }}
      ...
      .s-desc  {{ font-size:11px; color:#9ca3af; line-height:1.4; }}
      .mc {{
      ...
      .mt {{ font-size:10px; color:#6b7280; text-transform:uppercase; letter-spacing:0.5px; }}
      .mv {{ font-size:16px; font-weight:800; color:#f9fafb; line-height:1.2; }}
